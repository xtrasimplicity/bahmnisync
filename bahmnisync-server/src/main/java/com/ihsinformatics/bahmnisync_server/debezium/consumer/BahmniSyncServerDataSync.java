package com.ihsinformatics.bahmnisync_server.debezium.consumer;
...
import com.ihsinformatics.bahmnisync_server.util.DataType;

public class BahmniSyncServerDataSync {
	...
	public static ArrayList<JSONObject> syncData(String serverid, int chunckSize) throws Exception {
		
		BOOTSTRAP_SERVERS = BahmniSyncServer.appProps.getProperty("kafka.bootstrap.server.url");
    	TOPICS =  BahmniSyncServer.appProps.getProperty("kafka.topics");
    	MASTER_URL = BahmniSyncServer.appProps.getProperty("master.url");
    	GROUP_ID = serverid;
    	MAX_POLL_SIZE = String.valueOf(chunckSize);
    	...
    	for(ConsumerRecord<String,String> record: records){   
            ...
            String pkColumn = BahmniSyncServer.dbUtil.getPrimaryKey(table);
            ...
            if(!payload.getString("op").equals("d")){
                ...
                Object[][] foreignkeys = BahmniSyncServer.dbUtil.getTableData(query);
                ...
                for (Object[] fk : foreignkeys){
                  ...
                  if(dt.equals(DataType.INT32.label)){
                	  ...
                	  if(!fkValue.equals(null))	{
                	  	...
                	  	String uuid = BahmniSyncServer.dbUtil.getValue(fktableReference);
