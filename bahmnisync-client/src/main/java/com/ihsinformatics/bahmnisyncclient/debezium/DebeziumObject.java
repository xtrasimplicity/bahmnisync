...
public class DebeziumObject {
	...
	public void replacePrimaryKeyTagsInQuery (){
		...
		for(Map<String,Object> keys : fk){
			...
			String qValue = BahmniSyncClient.dbUtil.getValue(q);
			
			this.query = query.replace("<"+String.valueOf(keys.get("COLUMN_NAME")) +">", qValue);
